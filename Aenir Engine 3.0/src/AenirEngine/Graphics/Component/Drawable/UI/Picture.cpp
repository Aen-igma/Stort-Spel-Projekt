...
namespace Aen {
    ...
    Aen::Picture::Picture():mp_WFactory(nullptr), mp_BCoder(nullptr), mp_FormatConverter(nullptr), mp_FrameDecode(nullptr)
    {}
    ...
    void Aen::Picture::AddPicture(LPCWSTR path, int indX)
    {
        PictureData data;
