...
namespace Aen
{
	...
	{
	public:
		static void LoadFbx(sm::Vector3*& pPosV, VBuffer<Vertex>& vBuffer, const std::string path, std::vector<PartitionData>& partitions, std::unordered_map<std::string, uint32_t>& meshMaterial);
	private:
