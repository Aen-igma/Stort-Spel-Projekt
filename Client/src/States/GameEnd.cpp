...
void GameEnd::Initialize()
{
	...
	if (!GetWin())
		m_UI->GetComponent<Aen::UIComponent>().AddPicture(AEN_RESOURCE_DIR_W(L"GameOver.png"));
	else 
		m_UI->GetComponent<Aen::UIComponent>().AddPicture(AEN_RESOURCE_DIR_W(L"Victory.png"));
