...
Victory::Victory(Aen::Window& window)
...
void Victory::Update(const float& deltaTime)
{
...
void Victory::Initialize()
{
	...
	m_UI->GetComponent<Aen::UIComponent>().AddPicture(AEN_RESOURCE_DIR_W(L"Victory.png"), 0);
